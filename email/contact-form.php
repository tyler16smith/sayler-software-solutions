...
if( ! empty( $_POST['email'] ) ) {
	...
	$receiver_email = 'tylersmithis414@gmail.com';

	// Email Receiver Name for SMTP Email
	$receiver_name 	= 'Tyler Smith';
	...
	// Email Subject
	$subject = 'Sayler Solutions: Message from ' . $name;
	...
	if( $enable_smtp == 'no' ) { // Simple Email
		...
		$mail->SMTPAuth = True;
		$mail->Username = 'tylersmithis414@gmail.com'; // Your Username
		$mail->Password = 'yvpicjxdutetahnd'; // Your Password
